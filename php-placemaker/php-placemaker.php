...
<head> 
 <title>PHPPlacemaker - geolocate web sites and texts with Yahoo! Placemaker in PHP</title> 
  ...
  form {background: #E4F7C7;width: 100%;border-radius: 10px;-moz-border-radius: 10px;-webkit-border-radius: 10px;}  
  form table{border: 1px solid #F2FFDF;}
   ...
   <div id="hd" role="banner"><h1>Geolocate web sites and texts with Yahoo! Placemaker</h1></div> 
       ...
       <div id="bd" role="main"> 
                  ...
                  <div class="yui-g"> 
                     ...
                     <p><strong>Placemaker</strong> - a location extraction web service released at Where 2.0. Using Placemaker you can find all the geographical locations in a feed or a text or a web url and you get them back as an array of places.</p>
                     <form action="<?php echo$_SERVER['PHP_SELF'];?>" method="POST"> 
                     <table>
                       <tr><td>Enter web site URL:</td><td><input type="text" name="url" id="url" size="40" value="<?php if($_POST['url']) echo$_POST['url'];?>"/></td><td>&nbsp;</td></tr>
                       <tr><td>Enter a text:</td><td><textarea cols="37" rows="5" name="text" id="text" ><?php if($_POST['text']) echo$_POST['text'];?></textarea></td><td>&nbsp;</td></tr>
                       ...
                       <tr><td><a href="php-placemaker.phps">source</a></td></tr>
                     </table>
                    </form>
                  </div> 
